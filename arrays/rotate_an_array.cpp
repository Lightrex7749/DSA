...
// Time Complexity: O(n) for both rotations
// Space Complexity: O(k) for the temporary array used in both rotations


// Alternative approach using reversal method
...
// Time Complexity: O(n) for both rotations
// Space Complexity: O(1) since we are doing in-place rotations